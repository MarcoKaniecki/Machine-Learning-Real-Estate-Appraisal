      ...
      <div name='appraisal' className='w-full mt-24'>
        ...
        <div className='max-w-[1240px] mx-auto text-white relative'>
          ...
          <div className='px-4 py-12'>
            ...
            <h3 className='text-5xl fond-bold py-6 text-center'>Steps to Get Your Home Appraisal Report:</h3>
            <p className='py-4 text-3xl text-slate-300 text-center'>Add images of the home to include in the report. 
            Then, complete the form below to provide information for the appraisal. Press the 'Appraise!' button, and shortly after you will be able to download a PDF copy of your appraisal.
            The document will contain your input information and images, a price prediction generated by our model, and information on five comparable properties for your reference. </p>
          </div>
          ...
          <div className='grid grid-cols-1 relative gap-x-8 gap-y-16 px-4 pt-12 sm:pt-10 text-black'>
            ...
            <div className='bg-white rounded-xl shadow-2xl'>
              <div className='p-8'>
                ...
                <h3 className='font-bold text-2xl my-6'>Property Information</h3>

                {/* div containing all the input fields organized in a grid */}
                <div className="grid gap-6 mb-6 md:grid-cols-2">
                  ...
                  <div>
                    <label className="block mb-2 text-sm font-medium text-gray-900">Lot Area (sqft)</label>
                ...
                <h3 className='font-bold text-2xl my-6'>Building Details</h3>
                <div className="grid gap-6 mb-6 md:grid-cols-2">
                  ...
                  <div>
                    <label className="block mb-2 text-sm font-medium text-gray-900">Area of Finished Basement (sqft)</label>
                  ...
                  <div>
                    <label className="block mb-2 text-sm font-medium text-gray-900">Total Area of Basement (sqft)</label>
                ...
                <h3 className='font-bold text-2xl my-6'>Property Condition</h3>
                <div className="grid gap-6 mb-6 md:grid-cols-2">
                  {/* overall quality input field */}
                  <div>
                    <label className="block mb-2 text-sm font-medium text-gray-900">Overall Quality: Overall Material and Finish of the House</label>
                  ...
                  <div>
                    <label className="block mb-2 text-sm font-medium text-gray-900">Overall Condition: Overall Condition of the House</label>
                ...
                <h3 className='font-bold text-2xl my-6'>Room Information</h3>
                <div className="grid gap-6 mb-6 md:grid-cols-2">

                  
                  {/* Room Information subsection */}
                ...
                <h3 className='font-bold text-2xl my-6'>Garage Information</h3>
                <div className="grid gap-6 mb-6 md:grid-cols-2">
                  ...
                  <div>
                    <label className="block mb-2 text-sm font-medium text-gray-900">Size of Garage (sqft)</label>
                ...
                <h3 className='font-bold text-2xl my-6'>Outdoor Information</h3>
                <div className="grid gap-6 mb-6 md:grid-cols-2">
                  {/* size of wooden deck input field */}
                  <div>
                    <label className="block mb-2 text-sm font-medium text-gray-900">Wood Deck Area (sqft)</label>
